...
@section("content")
<div class="card">
    <form action="/admin/category<?php echo (is_null($model)) ? "" :"/". $model->id ?>" class="form-horizontal"
        ...
        <div class="modal-dialog modal-lg" role="document" style="width: 1000px">
            ...
            <div class="card-content">
                <div class="modal-header">
                    <h4 class="modal-title bold">Kategori
                    </h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 control-label bold">Kategori</div>
                                <div class="col-md-7">
                            <select name="category_id" class="form-control">
                                ...
                                <?php
                                    if(is_null($model)) {
                                        ...
                                        if($item->id==$model->id) echo "selected";
                                    }
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 control-label bold">İngilizce Adı</div>
                                    <div class="col-md-7">

                                        <input class="form-control    required"
                                               name="en_name" value="{{(is_null($model)) ? old('en_name') : $model->en_name}}"
                                               type="text"/>
